...
import { ApeSwapV3PoolSwapTest } from '../typechain/ApeSwapV3PoolSwapTest'
...
describe('ApeSwapV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('ApeSwapV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as ApeSwapV3PoolSwapTest
          ...
          let tester: ApeSwapV3PoolSwapTest
