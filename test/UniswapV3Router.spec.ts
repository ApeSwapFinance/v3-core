...
describe('ApeSwapV3Pool', () => {
  ...
  let pool0: MockTimeApeSwapV3Pool
  let pool1: MockTimeApeSwapV3Pool
  ...
  let swapTargetCallee: TestApeSwapV3Callee
  let swapTargetRouter: TestApeSwapV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeApeSwapV3Pool, any]> => {
